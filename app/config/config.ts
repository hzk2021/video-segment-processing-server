...
export const config = {
  ...
  server: {
    ...
    allowedIPs: getEnvVar(ENV_KEYS.SERVER.ALLOWED_IPS, '127.0.0.1,::1').split(',')  // Add this for IP whitelist
  },
  processing: {
...
export function validateConfig(): void {
  ...
  try {
    ...
    console.warn(`Warning: Could not access or create temp directory: ${error.message}`);
